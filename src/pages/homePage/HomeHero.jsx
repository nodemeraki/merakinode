...
const HomeHero = () => {
  return (
    <section className="h-[48vh] md:h-[85vh] sm:h-[40vh] bg-body">
      <div className="bg-[url('/images/Hero.png')] h-[75%] md:h-[98%] max-w-[90%] w-full mx-auto rounded-xl md:rounded-2xl overflow-hidden bg-cover bg-center font-homeHero font-lexend shadow-gray-500 shadow-2xl">
